...
export function ResultsView({ analysis, tier }: Props) {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      {/* AI Disclaimer */}
      <div className="mt-8 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-xl p-4 flex gap-3">
        <span className="text-amber-500 text-lg shrink-0">⚠️</span>
        <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">
          <strong>Disclaimer:</strong> The business ideas and analysis generated by IdeaForge AI are for informational
          purposes only and do not constitute financial, legal, or business advice. Results are AI-generated and may
          contain errors. Always conduct your own research and consult qualified professionals before making business
          decisions. IdeaForge AI does not guarantee any specific income or business success.
        </p>
      </div>
